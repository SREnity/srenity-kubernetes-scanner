...
curl -H "Authorization: Token token=\"$(echo -n ${PUBLIC_ID}):$(echo -n ${PRIVATE_KEY})\"" -H 'Content-type: application/json' --data @final_data.json -vvv 'https://srenitydashboard.io/api/v1/user_plugins/external_update.json'
